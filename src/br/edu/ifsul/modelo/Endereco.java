...
public class Endereco implements Serializable {
    ...
    @Length(max = 20, message = "O apelido não deve ter mais que {max} caracteres")
    ...
    @Column(name = "endereço", length = 50, nullable = false)
    private String endereco;

    @NotBlank(message = "O numero deve ser informado")
    @Length(max = 10, message = "O numero não deve ter mais que {max} caracteres")
    @NotNull(message = "O numero não pode ser nulo")
    @Column(name = "numero", length = 10, nullable = false)
    private String numero;

    @Length(max = 20, message = "O complemento não deve ter mais que {max} caracteres")
    @Column(name = "complemento", length = 20, nullable = false)
    private String complemento;

    @NotBlank(message = "O CEP deve ser informado")
    @Length(max = 9, message = "O CEP não deve ter mais que {max} caracteres")
    ...
    @Length(max = 30, message = "A referência não deve ter mais que {max} caracteres")
